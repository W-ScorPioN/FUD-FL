...
from models.Nets import MLP, CNNMnist, CNNCifar, resnet18, resnet101
...
if __name__ == '__main__':
    ...
    args = args_parser()
    logging.basicConfig(filename=f'./save/log/{args.dataset}_{args.model}_{str(args.epochs)}_{str(args.num_users)}_{args.model}_{str(args.iid)}_{str(args.frac)}_{str(args.bs)}_{args.task_id}.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
    # parse args
    args = args_parser()
